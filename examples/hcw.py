...
if __name__ == "__main__":
    ...
    regex_dir = os.path.join('regexes', 'tb_regexes', 'hcw')
    ...
    if not debug:
        ...
        _, temp_labels, temp_ids = di.data_from_excel(label_filenames, id_cols=0, label_cols=1, repeat_ids=False, first_row=1, check_col=0)
        # print(temp_labels)
    ...
    tb_regex_naive = RegexClassifier("Basic HCW Classifier", regexes)
    ...
    for data_set in ["train", "valid"]:
        ...
        generate_error_report(output_dir, "hcw_error_report.html", template_directory, 'error_report.html',
                              "HCW", regexes.keys(), failures_dict, effects, custom_effect_colours=effect_colours)

        generate_classification_report(output_dir, "hcw_report.html", template_directory, 'classification_report.html',
                                       "HCW", regexes.keys(), all_patients_dict, effects, custom_effect_colours=effect_colours)
