...
if __name__ == "__main__":
    ...
    for rule in cur_run:
        ...
        if not debug:
            ...
            for cur_dataset in datasets:
                debug_data = ["She migrated from Trinidad in 1999",
                              "He immigrated from the US in 1920. He moved to Canada in 1920", "He is Canadian."]
                debug_labels = ["Trinidad", "US", "Canada"]
                debug_ids = ["0", "1", "2"]
                classifier_runner = load_classifier_data(classifier_runner, debug_data, debug_labels,
